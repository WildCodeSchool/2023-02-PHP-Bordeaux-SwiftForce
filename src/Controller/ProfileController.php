...
class ProfileController extends AbstractController
{
    ...
    public function contactPromo(): void
    {
        ...
        $mail = new sendMail();
        $mail->sendMail('contact@thewildshop.com', 'The Wild Shop', $customerEmail, $customerName, 'Offre de bienvenue', 'Profitez de 15% de remise sur vôtre 1ère commande avec le code : BIENVENUE. Voir conditions sur le site.');
